...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        #contracting
        self.conv1 = nn.Conv2d(in_channels=1,out_channels=16,kernel_size=3,stride=1,padding="same",bias=True) 
        ...
        #expansive path        
        self.conv11= nn.ConvTranspose2d(in_channels=256,out_channels=128,kernel_size=2,stride=2,padding=0,bias=True) #
        self.conv12= nn.Conv2d(in_channels=256,out_channels=128,kernel_size=3,stride=1,padding="same",bias=True)
        ...
        self.conv14= nn.ConvTranspose2d(in_channels=128,out_channels=64,kernel_size=2,stride=2,padding=0,bias=True) #
        self.conv15= nn.Conv2d(in_channels=128,out_channels=64,kernel_size=3,stride=1,padding="same",bias=True) #
        ...
        self.conv17= nn.ConvTranspose2d(in_channels=64,out_channels=32,kernel_size=2,stride=2,padding=0,bias=True) #
        self.conv18= nn.Conv2d(in_channels=64,out_channels=32,kernel_size=3,stride=1,padding="same",bias=True) #
        ...
        self.conv20= nn.ConvTranspose2d(in_channels=32,out_channels=16,kernel_size=2,stride=2,padding=0,bias=True) #
        self.conv21= nn.Conv2d(in_channels=32,out_channels=16,kernel_size=3,stride=1,padding="same",bias=True) #
    ...
    def forward(self, x):
        ...
        x5 = torch.cat((x5,x3),1)  # concatanete
        ...
        x6 = torch.cat((x6,x2),1)  # concatanete
        ...
        x7 = torch.cat((x7,x1),1)  # concatanete
        ...
        x8 = torch.cat((x8,x),1)  # concatanete
